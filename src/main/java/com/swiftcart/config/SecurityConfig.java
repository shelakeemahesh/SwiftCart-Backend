    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/users/**").hasAnyRole("CUSTOMER", "SELLER", "ADMIN")
                ...
                .requestMatchers("/api/v1/wishlist/**").hasAnyRole("CUSTOMER", "SELLER", "ADMIN")
                .requestMatchers("/api/v1/coupons/**").hasAnyRole("CUSTOMER", "SELLER", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/v1/reviews/**").hasAnyRole("CUSTOMER", "SELLER", "ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/reviews/**").hasAnyRole("CUSTOMER", "SELLER", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/reviews/**").hasAnyRole("CUSTOMER", "SELLER", "ADMIN")
